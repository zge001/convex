...
class TestAngle1:
    ...
    # Инициализация (выполняется для каждого из тестов класса)
    def setup_method(self):
        self.a = R2Point(7.0, 8.0)
        self.b = R2Point(11.0, 8.0)
        self.c = R2Point(12.0, 6.0)
        self.pol = Polygon(self.a, self.b, self.c)
        self.d = R2Point(11.0, 3.0)
        self.e = R2Point(7.0, 1.0)
        self.f = R2Point(2.0, 3.0)
        self.h = R2Point(3.0, 6.0)
        self.pol.add(self.d)
        self.pol.add(self.e)
        self.pol.add(self.f)
        self.pol.add(self.h)
    ...
    def test_angle(self):
        assert self.pol.acute_angles_num == 0
...
class TestAngle2:
    ...
    # Инициализация (выполняется для каждого из тестов класса)
    def setup_method(self):
        self.a = R2Point(5.0, 18.0)
        self.b = R2Point(11.0, 8.0)
        self.c = R2Point(12.0, 6.0)
        self.pol = Polygon(self.a, self.b, self.c)
        self.d = R2Point(13.0, 1.0)
        self.e = R2Point(7.0, 1.0)
        self.f = R2Point(2.0, 3.0)
        self.h = R2Point(3.0, 6.0)
        self.pol.add(self.d)
    ...
    def test_angle(self):
        assert self.pol.acute_angles_num == 2
...
class TestAngle3:
    ...
    def setup_method(self):
        self.a = R2Point(7.0, 8.0)
        self.b = R2Point(11.0, 8.0)
        self.c = R2Point(16.0, 5.0)
        self.pol = Polygon(self.a, self.b, self.c)
        self.d = R2Point(12.0, 2.0)
        self.e = R2Point(7.0, 1.0)
        self.f = R2Point(2.0, 3.0)
        self.h = R2Point(3.0, 6.0)
        self.pol.add(self.d)
    ...
    def test_angle(self):
        assert self.pol.acute_angles_num == 1
...
class TestAngle4:
    ...
    def setup_method(self):
        ...
        self.b = R2Point(2.0, 3.0)
        self.c = R2Point(3.0, 1.0)
        self.pol = Polygon(self.a, self.b, self.c)

    def test_angle(self):
        assert self.pol.acute_angles_num == 3
...
class TestAngle6:
    ...
    # Инициализация (выполняется для каждого из тестов класса)
    def setup_method(self):
        self.a = R2Point(-3.0, 2.0)
        self.b = R2Point(1.0, 4.0)
        self.c = R2Point(4.0, -1.0)
        self.pol = Polygon(self.a, self.b, self.c)
        self.d = R2Point(1.0, -3.0)
        self.e = R2Point(-3.0, -2.0)
        self.f = R2Point(4.0, -3.0)
        self.g = R2Point(4.0, 3.0)
        self.h = R2Point(-2.0, 4.0)
        self.pol.add(self.d)
        self.pol.add(self.e)
        self.pol.add(self.f)
        self.pol.add(self.g)
...
class TestAngle7:
    ...
    def setup_method(self):
        self.a = R2Point(-3.0, 2.0)
        self.b = R2Point(1.0, 4.0)
        self.c = R2Point(5.0, -1.0)
        self.pol = Polygon(self.a, self.b, self.c)
        self.d = R2Point(-1.0, -5.0)
        self.e = R2Point(-3.0, -2.0)
        self.f = R2Point(5.0, -7.0)
        self.g = R2Point(4.0, 3.0)
        self.h = R2Point(-2.0, 4.0)
        self.pol.add(self.d)
        self.pol.add(self.e)
